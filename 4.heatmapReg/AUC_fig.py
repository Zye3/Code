...
def main():
    ...
    errors_centers, errors_corners = LandmarkError(img_list,normalization=['centers','corners'])
    failureThreshold = 0.35   # 可修改x轴最大值
    AUCError(errors_centers, failureThreshold, file="./results/frgc_sdu_centers.txt")
    AUCError(errors_corners, failureThreshold, file="./results/frgc_sdu_corners.txt")
