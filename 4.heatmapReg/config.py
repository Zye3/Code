...
config.num_classes = 68# 68 landmarks
config.record_img_size = 384# total
...
# default dataset
default.dataset = 'i2d'
default.frequent = 20 #each iteration 20images
default.verbose = 200#
default.kvstore = 'device'

default.prefix = 'model/A'
default.end_epoch = 1000
default.lr = 0.00025#0.00025
default.wd = 0.0
default.per_batch_size =16
default.lr_step = '16000,24000,30000'# 16000,24000,30000
